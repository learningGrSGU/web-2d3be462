...
<body>
<div id="topmenu">
    <div style="width:3%;float:right;padding-top:2px;"><a href="?gh"><img src="image/shopping-cart-solid.png"
                                                                          class="shoppingicon"></a></div>
    <div style="width:20%;float:right;padding-top:3px">
        <div id='name' style="text-align:center;"><img src="image/user-solid.png" style="height:30px;width:30px;">
            <div id="user"><a href="?LSGD=lsgd&pageActive=1">Lịch sử giao dịch</a>
                <button class="logout" onClick="logout();">Đăng xuất</button>
            </div>
        </div>
    </div>
    <div class="filter">
        <button style="width:100%;height:100%;" onclick="$('#vance').toggle('fast');">Lọc</button>
    </div>
    <div style="width:50%;height:35px;float:right;"><input
                style="height:100%;border:1px solid white;border-radius:5px;	margin:2.5px;" id="dataSearch"
                onKeyUp="Search(1);" type="text" placeholder="Nhập tên điện thoại cần tìm" name="search"></div>
    <a href="index.php">
        <div style="font-size:100%;padding:10px 21px;color:#FFFFFF;font-family:'Times New Roman', Times, serif">
            BDLSHOP
        </div>
    </a>
    <div id='vance' style='display:none;clear:left;'></div>
    <div id="spSearch"></div>
    <div id="tr"></div>
