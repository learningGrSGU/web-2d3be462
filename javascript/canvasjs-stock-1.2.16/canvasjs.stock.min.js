...
(function () {
    ...
    function T(k) {
        var v = ((k & 16711680) >> 16).toString(16), e = ((k & 65280) >> 8).toString(16);
    ...
    function qb(k, v) {
        var e = this.length >>> 0, s = Number(v) || 0, s = 0 > s ? Math.ceil(s) : Math.floor(s);
    ...
    function ib(k) {
        if (k._menuButton) k.exportEnabled ? Sa(k._menuButton) : za(k._menuButton); else if (k.exportEnabled && s) {
            ...
            z(k._menuButton, "mouseout", function () {
                ...
                pa(k._menuButton.childNodes[0], {WebkitFilter: "invert(0%)", filter: "invert(0%)"}))
            }, k.allDOMEventHandlers, !0)
        }
...
k._creditLink.setAttribute("tabIndex",-1),k._creditLink.setAttribute("target","_blank"));if(0===k.renderCount||v||e)k._creditLink.setAttribute("href",k.creditHref),k._creditLink.innerHTML=k.creditText;k._creditLink&&k.creditHref&&k.creditText?(k._creditLink.parentElement||k._canvasJSContainer.appendChild(k._creditLink),k._creditLink.style.top=k.height-14+"px"):k._creditLink.parentElement&&k._canvasJSContainer.removeChild(k._creditLink)}
        }*/
    }
    ...
    var Ma = !1, M = {}, s = !!document.createElement("canvas").getContext,
        ...
        }, Qa = {en: {}}, w = s ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
    ...
    var ka = 20, F = 14, Fa = {
        ...
        title: {fontFamily: Aa, fontSize: 32, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5},
        subtitles: [{fontFamily: Aa, fontSize: F, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5}],
        data: [{
        ...
        axisY: [{
            ...
            crosshair: {
                labelFontFamily: w, labelFontSize: F, labelFontColor: "#EEEEEE", labelFontWeight: "normal",
                labelBackgroundColor: sa, color: U, thickness: 1, lineDashType: "dash"
            },
            scaleBreaks: {type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid"}
        }],
        axisY2: [{
    ...
    var ka = 20, F = 14, Ia = {
        ...
        axisX2: [{
            ...
            gridColor: "#BBBBBB",
            stripLines: [{
                labelFontFamily: w, labelFontSize: F, labelFontColor: "#FFA500", labelFontWeight: "normal",
    ...
    U = {
        ...
        subtitles: [{fontFamily: w, fontSize: F, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5}],
        toolbar: {
            backgroundColor: "#666666",
            backgroundColorOnHover: "#FF7372",
            borderColor: "#FF7372",
    ...
    var ab = {light1: Fa, light2: Ia, dark1: Aa, dark2: U, theme1: Fa, theme2: Ia, theme3: Fa}, S = {
        numberDuration: 1,
    ...
    (function () {
        ...
        M._fTWm = function (k) {
            if ("undefined" === typeof M.pro.sCH && !lb) try {
                var e = (new Date).getMonth() % 3, s, I, W = k[M.fSDec(M.obj.cntx)];
    ...
    var sb = function () {
            ...
            return function (w, z, N) {
                var F = N ? N.days : e, L = N ? N.months : I, R = N ? N.shortDays : s, M = N ? N.shortMonths : W;
                N = "";
                var d = !1;
                ...
                N = d ? "getUTC" : "get";
                var t = w[N + "Date"](), x = w[N + "Day"](), r = w[N + "Month"](), a = w[N + "FullYear"](),
                    f = w[N + "Hours"](), b = w[N +
                    "Minutes"](), c = w[N + "Seconds"](), h = w[N + "Milliseconds"](), g = d ? 0 : w.getTimezoneOffset();
            ...
            var I = 0 > k ? !0 : !1;
            I && (k *= -1);
            var w = s ? s.decimalSeparator : ".", D = s ? s.digitGroupSeparator : ",", A = "";
            e = String(e);
            var A = 1, z = s = "", F = -1, N = [], L = [], R = 0, M = 0, J = 0, d = !1, t = 0,
                z = e.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            e = null;
            for (var x =
            ...
            return {x: s, y: V}
        }, kb = !0, Ya = window.devicePixelRatio || 1, Ua = 1, ja = kb ? Ya / Ua : 1,
        ...
        ub = lb && -1 === window[va("mnb`uhno")].href.indexOf(va("gheemd")), vb = {
    ...
    Y.prototype.updateOption = function (k) {
        ...
        var s = ia[this._defaultsKey], w = {}, I = this[k], z = this._themeOptionsKey,
            D = this._index;
    ...
    Y.prototype.addEventListener = function (e, s, w) {
        e && s && (this._eventListeners[e] =
            this._eventListeners[e] || [], this._eventListeners[e].push({context: w || this, eventHandler: s}))
    };
    ...
    ma.prototype._wrapText = function () {
        var e = new String(Pa(String(this.text))), s = [], w = this.ctx.font, z = 0, F = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) F = z = 0; else for (; 0 < e.length;) {
            ...
            s.push(A);
            var J = F, F = Math.max(F, A.width), z = z + A.height, e = Pa(e.slice(A.text.length, e.length));
    ...
    Ha.prototype.setLayout = function () {
        if (this.text) {
            var s = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, v = s.layoutManager.getFreeSpace(),
                w = v.x1, z = v.y1, F = 0, D = 0,
                A = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, J, M;
    ...
    var Ja = Ra.Chart = function () {
        ...
        function F(a, f, b, c, h, g, E, e, d, m) {
            ...
            var n = 1 === Math.round(E.thickness) % 2 ? 0.5 : 0, p = 1 === Math.round(e.thickness) % 2 ? 0.5 : 0;
            a.save();
            a.globalAlpha = m;
        ...
        v.prototype._processMultiseriesPlotUnit =
            function (a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, h, g = !1, E = 0; E < a.dataSeriesIndexes.length; E++) {
                    var e = this.data[a.dataSeriesIndexes[E]], d = 0, m = !1, n = !1, p;
        ...
        v.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, h, g = !1, E = [], d = [], G = Infinity, m = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var p = this.data[a.dataSeriesIndexes[n]], q = 0, l = !1, y = !1, x;
            ...
            function (a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, h, g = !1, E = !1, d = !1, G = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                        var n = this.data[a.dataSeriesIndexes[m]], p = 0, q = !1, l = !1, y;
        ...
        v.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, h, g, E, e = !1, d = 0; d < a.dataSeriesIndexes.length; d++) {
                var m = this.data[a.dataSeriesIndexes[d]], n = 0, p = !1, q = !1, l, y, x;
        ...
        v.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes &&
                ...
                var e = this.data[a.dataSeriesIndexes[E]], d = 0, m = !1, n = !1, p = c = 0;
        ...
        v.prototype._touchEventHandler = function (a) {
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(b &&
                    ...
                    h.time = new Date;
                    try {
                        var E = h.y - this._lastTouchData.y, g = h.time - this._lastTouchData.time;
        ...
        v.prototype._plotAreaMouseUp = function (a, f) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                var b = f - this.dragStartPoint.y, c = a - this.dragStartPoint.x, h = 0 <= this.zoomType.indexOf("x"),
                    g = 0 <= this.zoomType.indexOf("y"), e = !1;
                this.resetOverlayedCanvas();
                if ("xySwapped" === this.plotInfo.axisPlacement) var d = g, g = h, h = d;
        ...
        v.prototype._plotAreaMouseMove = function (a, f) {
            if (this.isDrag &&
                ...
                var b = 0, c = 0, h = b = null, h = 0 <= this.zoomType.indexOf("x"),
        ...
        v.prototype.validateRegion = function (a, f, b, c, h) {
            ...
            for (e = 0; e < m.length; e++) {
                var p = m[e], g = !1, q = p.convertPixelToValue({x: a, y: f}), l = p.convertPixelToValue({x: b, y: c});
        ...
        v.prototype.renderIndexLabels = function (a) {
            var f = a || this.plotArea.ctx, b = this.plotArea, c = 0, h = 0, g = 0, E = g = h = 0, d = 0, G = c = 0,
                m = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var ga = qa("indexLabelLineDashType",
                    n.dataPoint, n.dataSeries), u = qa("indexLabelLineColor", n.dataPoint, n.dataSeries),
                ...
                if (null !== t && "" !== t) {
                    var r = qa("indexLabelPlacement", n.dataPoint, n.dataSeries),
                        k = qa("indexLabelOrientation", n.dataPoint, n.dataSeries), C = n.direction,
                        h = n.dataSeries.axisX, g = n.dataSeries.axisY, v = !1, wa = new ma(f, {
                            x: 0,
                            y: 0,
        ...
        v.prototype.renderLine = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : f;
                ...
                for (var g =
                    ...
                    if (b.setLineDash) {
                        var q = R(m.nullDataLineDashType, m.lineThickness), p = m.lineDashType,
                            l = R(p, m.lineThickness);
                        b.setLineDash(l)
                    }
                    var y = m.id;
                    this._eventManager.objectMap[y] = {objectType: "dataSeries", dataSeriesIndex: G};
                    y = T(y);
                    c.strokeStyle = y;
                    c.lineWidth = 0 < m.lineThickness ? Math.max(m.lineThickness, 4) : 0;
                    var y = m._colorSet, k = y = m.lineColor = m.options.lineColor ? m.options.lineColor :
                        y[0];
                    b.strokeStyle = y;
                    var ga = !0, u = 0, B, t;
                    b.beginPath();
                    if (0 < n.length) {
                        for (var v = !1, u = 0; u < n.length; u++) if (B = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !v))) if ("number" !== typeof n[u].y) 0 < u && !(m.connectNullData || v || ga) && (b.stroke(), s && c.stroke()), v = !0; else {
                            ...
                            this._eventManager.objectMap[w] = {
                                id: w, objectType: "dataPoint", dataSeriesIndex: G,
                                dataPointIndex: u, x1: B, y1: t
                            };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = [], e, d = 0; d < a.dataSeriesIndexes.length; d++) {
                    ...
                    c.lineWidth = 0 < m.lineThickness ? Math.max(m.lineThickness,
                        4) : 0;
                    var y = m._colorSet, k = y = m.lineColor = m.options.lineColor ? m.options.lineColor : y[0];
                    b.strokeStyle = y;
                    var ga = !0, u = 0, B, t;
                    b.beginPath();
                    if (0 < n.length) {
        ...
        v.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], l = this.data[q], y = l.dataPoints;
                    if (0 < y.length) for (var k = 5 < p && l.bevelEnabled ? !0 : !1, g = 0; g < y.length; g++) if (y[g].getTime ? G = y[g].x.getTime() : G = y[g].x, !(G < a.axisX.dataInfo.viewPortMin || G >
                        ...
                        (y[g].indexLabel || l.indexLabel || y[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: y[g],
                            dataSeries: l,
                            point: {x: e + (r - e) / 2, y: 0 > y[g].y === a.axisY.reversed ? d : u},
                            direction: 0 > y[g].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: e, y1: Math.min(d, u), x2: r, y2: Math.max(d, u)},
                            color: c
                        })
                    }
                }
        ...
        v.prototype.renderStackedColumn = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, h = this.plotArea, g = [], e = [], d = [], G = [], m = 0, n, p,
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var r = a.dataSeriesIndexes[y], k = this.data[r], u = k.dataPoints;
                    if (0 < u.length) {
                        var B = 5 <
                        ...
                        for (m = 0; m < u.length; m++) if (c = u[m].x.getTime ? u[m].x.getTime() : u[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[m].y) {
                            ...
                            var t = n - a.plotType.plotUnits.length * l / 2 + a.index * l << 0, v = t + l << 0, w;
                            ...
                            (u[m].indexLabel || k.indexLabel || u[m].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                bounds: {x1: t, y1: Math.min(p, w), x2: v, y2: Math.max(p, w)},
                                color: c
                            })
                        }
                    }
        ...
        v.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(h.x1, h.y1, h.width, h.height), this._eventManager.ghostCtx.clip());
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var k = a.dataSeriesIndexes[y], r = this.data[k], u = r.dataPoints;
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < y.length) {
                        ...
                        for (g = 0; g < y.length; g++) if (y[g].getTime ? G = y[g].x.getTime() : G = y[g].x, !(G < a.axisX.dataInfo.viewPortMin || G > a.axisX.dataInfo.viewPortMax) && "number" === typeof y[g].y) {
                            ...
                            var k = a.axisX.reversed ? d - p << 0 : d + p << 0, u;
                            0 <= y[g].y ? u = m : (u = e, e = m);
                            c = y[g].color ? y[g].color : l._colorSet[g % l._colorSet.length];
                            ...
                            (y[g].indexLabel ||
                                ...
                                dataPoint: y[g],
                                dataSeries: l,
                                point: {x: 0 <= y[g].y ? e : u, y: d + (k - d) / 2},
                                direction: 0 > y[g].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(u, e), y1: d, x2: Math.max(u, e), y2: k},
                                color: c
                            })
                        }
                    }
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    ...
                    if (0 < u.length) {
                        ...
                        typeof u[m].y) {
                            ...
                            var t = p - a.plotType.plotUnits.length * l / 2 + a.index * l << 0, w = t + l << 0, v;
                            ...
                            (u[m].indexLabel || r.indexLabel || u[m].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > u[m].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(v, n), y1: t, x2: Math.max(v, n), y2: w},
                                color: c
                            })
                        }
                    }
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (m = 0; m < u.length; m++) if (c = u[m].x.getTime ? u[m].x.getTime() : u[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[m].y) {
                            ...
                            var w =
                                p - a.plotType.plotUnits.length * l / 2 + a.index * l << 0, v = w + l << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[m].y) {
                                d[c] = t + (d[c] ? d[c] : 0);
                                if (0 >= d[c]) continue;
                                t = g[c] ? g[c] : q;
                            ...
                            (u[m].indexLabel || k.indexLabel ||
                                ...
                                direction: 0 > u[m].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(t, n), y1: w, x2: Math.max(t, n), y2: v},
                                color: c
                            })
                        }
                    }
        ...
        v.prototype.renderArea = function (a) {
            ...
            var h = a.targetCanvasCtx || this.plotArea.ctx, g = s ? this._preRenderCtx : h;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], l = this.data[q], y = l.dataPoints, G = l.id;
                    ...
                    var k = 0, t, u, B,
                        ...
                        v, ba = null;
                    if (0 < y.length) {
                        var C = l._colorSet[k % l._colorSet.length], A = l.lineColor = l.options.lineColor || C, z = A;
                        g.fillStyle = C;
                        g.strokeStyle = A;
        ...
        v.prototype.renderSplineArea = function (a) {
            ...
            var b = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : b;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this._eventManager.ghostCtx, g = a.axisY.lineCoordinates, e = [], d = this.plotArea;
                c.save();
                s && h.save();
                c.beginPath();
                ...
                for (var G =
                    ...
                    var m = a.dataSeriesIndexes[G], n = this.data[m], p = n.dataPoints, e = n.id;
                    this._eventManager.objectMap[e] = {objectType: "dataSeries", dataSeriesIndex: m};
                    e = T(e);
                    h.fillStyle = e;
                    var e = [], q = 0, l, y,
                        k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), t, u = null,
                        B = [];
                    if (0 < p.length) {
                        var v = n._colorSet[q % n._colorSet.length], La = n.lineColor = n.options.lineColor || v,
                            ba = La;
                        c.fillStyle = v;
                        c.strokeStyle = La;
                        ...
                        if (c.setLineDash) {
                            var A =
                                    R(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType,
                                z = R(C, n.lineThickness);
                            c.setLineDash(z)
                        }
        ...
        v.prototype.renderStepArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, d = a.axisY.lineCoordinates, G = [], m = this.plotArea, n;
                g.save();
                s && e.save();
                g.beginPath();
                g.rect(m.x1, m.y1, m.width, m.height);
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    f = !0;
                    var k = 0, t, u, B,
                        v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), w,
                        ba = null;
                    b = !1;
                    if (0 < y.length) {
                        var C = l._colorSet[k % l._colorSet.length], A = l.lineColor = l.options.lineColor || C, z = A;
                        ...
                        var O = "solid";
                        if (g.setLineDash) {
                            var ca = R(l.nullDataLineDashType, l.lineThickness), O = l.lineDashType,
                                fa = R(O, l.lineThickness);
                            g.setLineDash(fa)
                        }
                        for (; k < y.length; k++) if (B = y[k].x.getTime ? y[k].x.getTime() : y[k].x, !(B < a.axisX.dataInfo.viewPortMin ||
                            ...
                            "number" !== typeof y[k].y ? (l.connectNullData || (b || f) || c(), b = !0) : (t = a.axisX.convertValueToPixel(B), u = a.axisY.convertValueToPixel(y[k].y), f || b ? (!f && l.connectNullData ? (g.setLineDash && (l.options.nullDataLineDashType || O === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (f = t, b = u, t = n.x, u = n.y, c(), g.moveTo(n.x, n.y), t = f, u = b, ba = n, O = l.nullDataLineDashType, g.setLineDash(ca)), g.lineTo(t, aa), g.lineTo(t, u), s && (e.lineTo(t, aa), e.lineTo(t,
                                ...
                                dataSeriesIndex: q, dataPointIndex: k, x1: t, y1: u
                ...
                g.restore();
                return {
                    source: h, dest: this.plotArea.ctx, animationCallback: x.xClipAnimation,
        ...
        v.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = [], w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var ba = a.dataSeriesIndexes[w], C = this.data[ba], A = C.dataPoints;
                    C.dataPointIndexes = [];
                ...
                for (w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    m = [];
                    q = C.id;
                    this._eventManager.objectMap[q] = {objectType: "dataSeries", dataSeriesIndex: ba};
                    q = T(q);
                    t.fillStyle = q;
                    if (0 < n.length) {
                        var h = C._colorSet[0], z = C.lineColor = C.options.lineColor || h, O = z;
                        c.fillStyle = h;
                        c.strokeStyle = z;
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var g = n[q], la = null,
                                la = 0 <= C.dataPointIndexes[g] ? A[C.dataPointIndexes[g]] : {x: g, y: null};
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))) if ("number" !== typeof la.y) C.connectNullData || (aa || B) || f(), aa = !0; else {
                                ...
                                0 == q % 250 && (f(), c.moveTo(l, y), s && t.moveTo(l, y), m.push({x: l, y: k - ua})));
                                u = {x: l, y: y};
                                ...
                                if (0 <= C.dataPointIndexes[g]) {
                                    ...
                                    this._eventManager.objectMap[da] = {
                                        id: da, objectType: "dataPoint",
                                        dataSeriesIndex: ba, dataPointIndex: C.dataPointIndexes[g], x1: l, y1: y
                                    }
                                }
        ...
        v.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = null, g = null, e = this.plotArea, d = [], k = [], m = [], n = [], p = [], q = 0, l, y, t, v, u,
                ...
                for (var h = [], A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var ba = a.dataSeriesIndexes[A], C = this.data[ba], z = C.dataPoints;
                    C.dataPointIndexes =
                        [];
                ...
                for (A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    v = !0;
                    h = C.id;
                    this._eventManager.objectMap[h] = {objectType: "dataSeries", dataSeriesIndex: ba};
                    h = T(h);
                    w.fillStyle = h;
                    m = [];
                    if (0 < n.length) {
                        var h = C._colorSet[q % C._colorSet.length], D = C.lineColor = C.options.lineColor || h, O = D;
                        c.fillStyle = h;
                        c.strokeStyle = D;
                        c.lineWidth = C.lineThickness;
                        u = "solid";
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var g = n[q], la = null,
                                la = 0 <= C.dataPointIndexes[g] ? z[C.dataPointIndexes[g]] : {x: g, y: null};
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var y = 25 * Math.PI, t = Math.max(Math.pow(0.25 * Math.min(c.height, c.width) / 2, 2) * Math.PI, y), m = 0; m < a.dataSeriesIndexes.length; m++) if (n = a.dataSeriesIndexes[m], p = this.data[n], q = p.dataPoints, 0 < q.length) for (b.strokeStyle = "#4572A7 ", h = 0; h < q.length; h++) if (g = q[h].getTime ? g = q[h].x.getTime() : g = q[h].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[h].y) {
                    ...
                    (q[h].indexLabel || p.indexLabel ||
                        ...
                        point: {x: g, y: e},
                        direction: 1,
                        bounds: {x1: g - l.size / 2, y1: e - l.size / 2, x2: g + l.size / 2, y2: e + l.size / 2},
                        color: null
                    })
                }
        ...
        v.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                    var k = a.dataSeriesIndexes[d], m = this.data[k], n = m.dataPoints;
                    if (0 < n.length) {
                        b.strokeStyle = "#4572A7 ";
                        ...
                        for (var p = 0, q = 0, h = 0; h < n.length; h++) if (g = n[h].getTime ? g = n[h].x.getTime() : g = n[h].x, !(g < a.axisX.dataInfo.viewPortMin ||
                            ...
                            Math.sqrt((p - g) * (p - g) + (q - e) * (q - e)) < Math.min(l.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = m.dataPointIds[h], this._eventManager.objectMap[p] = {
                                id: p, objectType: "dataPoint", dataSeriesIndex: k,
                                dataPointIndex: h, x1: g, y1: e
        ...
        v.prototype.renderCandlestick =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var h = null, g = null, d = this.plotArea, k = 0, t, m, n, p, q, l,
                    ...
                    for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                        var w = a.dataSeriesIndexes[r], u = this.data[w], B = u.dataPoints;
                        if (0 < B.length) for (var v = 5 < y && u.bevelEnabled ? !0 : !1, k = 0; k < B.length; k++) if (B[k].getTime ? l = B[k].x.getTime() : l = B[k].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !e(B[k].y) && B[k].y.length && "number" === typeof B[k].y[0] && "number" === typeof B[k].y[1] && "number" === typeof B[k].y[2] && "number" === typeof B[k].y[3]) {
                            ...
                            var A = t - y / 2 << 0, z = A + y << 0,
                                ...
                                h = B[k].color ? B[k].color : u._colorSet[0], C = Math.round(Math.max(1, 0.15 * y)),
                                D = 0 === C % 2 ? 0 : 0.5, F = u.dataPointIds[k];
                            ...
                            (B[k].indexLabel || u.indexLabel || B[k].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 1,
                                bounds: {x1: A, y1: Math.min(n, p), x2: z, y2: Math.max(n, p)},
                                color: h
                            })
                        }
                    }
        ...
        v.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = !1, r = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var u = a.dataSeriesIndexes[w], B = this.data[u], v = B.dataPoints;
                    ...
                    !e(v[d].y) && v[d].y.length && "number" === typeof v[d].y[0] && "number" === typeof v[d].y[1] && "number" === typeof v[d].y[2] && "number" === typeof v[d].y[3] && "number" === typeof v[d].y[4] && 5 === v[d].y.length) {
                        ...
                        var z = k - y / 2 << 0, C = k + y / 2 << 0, h = v[d].color ? v[d].color : B._colorSet[0],
                            ...
                            y / 100 > y ? y : parseInt(aa) * y / 100 : y, la = 1 === Math.round(ca) % 2 ? 0.5 : 0,
                            ...
                            P = 1 === Math.round(M) % 2 ? 0.5 : 0, N = B.upperBoxColor, L = B.lowerBoxColor,
                            ya = e(B.options.fillOpacity) ? 1 : B.fillOpacity, Q = B.dataPointIds[d];
                        ...
                        (v[d].indexLabel || B.indexLabel || v[d].indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: v[d],
                            dataSeries: B,
                            point: {x: z + (C - z) / 2, y: a.axisY.reversed ? t : p},
                            direction: 1,
                            bounds: {x1: z, y1: Math.min(t, p), x2: C, y2: Math.max(t, p)},
                            color: h
                        })
                    }
                }
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < l.length) for (var y = 5 < m && q.bevelEnabled ? !0 : !1, g = 0; g < l.length; g++) if (l[g].getTime ? t = l[g].x.getTime() : t = l[g].x, !(t <
                        ...
                        if (l[g].indexLabel || q.indexLabel || l[g].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                            ...
                            dataSeries: q,
                            indexKeyword: 0,
                            point: {x: r + (v - r) / 2, y: l[g].y[1] >= l[g].y[0] ? k : d},
                            direction: l[g].y[1] >=
                            l[g].y[0] ? -1 : 1,
                            bounds: {x1: r, y1: Math.min(d, k), x2: v, y2: Math.max(d, k)},
                            color: c
                            ...
                            dataSeries: q,
                            indexKeyword: 1,
                            point: {x: r + (v - r) / 2, y: l[g].y[1] >= l[g].y[0] ? d : k},
        ...
        v.prototype.renderError = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx :
                f, c = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = null, g = !1, d = this.plotArea, k = 0, t, m, n, p, q, l, y, r = a.axisX.dataInfo.minDiff;
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var w = a.dataSeriesIndexes[B], A = this.data[w], z = A.dataPoints,
                    ...
                    if (0 < z.length) for (var J = A._colorSet,
                                               k = 0; k < z.length; k++) {
                        var h = A.lineColor = A.options.color ? A.options.color : J[0], O = {
        ...
        v.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(h.x1,
                    h.y1, h.width, h.height), this._eventManager.ghostCtx.clip());
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], l = this.data[q], y = l.dataPoints;
                    if (0 < y.length) {
                        ...
                        for (g = 0; g < y.length; g++) if (y[g].getTime ? m = y[g].x.getTime() : m = y[g].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !e(y[g].y) && y[g].y.length && "number" === typeof y[g].y[0] && "number" === typeof y[g].y[1]) {
                            ...
                            if (y[g].indexLabel || l.indexLabel || y[g].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: l,
                                indexKeyword: 0,
                                point: {x: y[g].y[1] >= y[g].y[0] ? d : k, y: t + (v - t) / 2},
                                direction: y[g].y[1] >= y[g].y[0] ? -1 : 1,
                                bounds: {x1: Math.min(d, k), y1: t, x2: Math.max(d, k), y2: v},
                                color: c
                            }), this._indexLabels.push({
                                chartType: "rangeBar",
                                dataPoint: y[g],
                                dataSeries: l,
                                indexKeyword: 1,
                                point: {x: y[g].y[1] >= y[g].y[0] ? k : d, y: t + (v - t) / 2},
                                direction: y[g].y[1] >=
                                y[g].y[0] ? 1 : -1,
                                bounds: {x1: Math.min(d, k), y1: t, x2: Math.max(d, k), y2: v},
                                color: c
        ...
        v.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                    ...
                    if (0 < p.length) {
                        var w = n._colorSet[l % n._colorSet.length], z = n.lineColor = n.options.lineColor || w, A = z;
                        c.fillStyle = w;
                        c.strokeStyle = z;
                        c.lineWidth = n.lineThickness;
                        var C = "solid";
                        if (c.setLineDash) {
                            var D = R(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType,
                                F = R(C, n.lineThickness);
                            c.setLineDash(F)
                        }
                        for (var O = !0; l < p.length; l++) if (u = p[l].x.getTime ?
                            ...
                            q || O ? (n.connectNullData && !q ? (c.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = F, C = n.nullDataLineDashType,
                                ...
                                y1: t,
                                y2: v
                            })) : (c.beginPath(), c.moveTo(y, t), B = {x: y, y: t}, k = [], k.push({
                                x: y,
                                y1: t,
                                y2: v
        ...
        v.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                s && (h.beginPath(), h.rect(e.x1, e.y1, e.width, e.height), h.clip());
                for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                    var k = a.dataSeriesIndexes[d], m = this.data[k], n = m.dataPoints, g = m.id;
                    ...
                    var g = [], p = 0, q,
                        l, y, t = [], v = [];
                    if (0 < n.length) {
                        var u = m._colorSet[p % m._colorSet.length], B = m.lineColor = m.options.lineColor || u, z = B;
                        c.fillStyle = u;
                        c.lineWidth = m.lineThickness;
                        var A = "solid", D;
                        if (c.setLineDash) {
                            var C = R(m.nullDataLineDashType, m.lineThickness), A = m.lineDashType;
        ...
        v.prototype.renderWaterfall = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = this._eventManager.ghostCtx, h = null, g = this.plotArea, e = 0, d, k, m, n,
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var y =
                        a.dataSeriesIndexes[l], t = this.data[y], r = t.dataPoints, h = t._colorSet[0];
                    ...
                    if (0 < r.length) for (var v = 5 < q && t.bevelEnabled ? !0 : !1, w = !1, A = null, C = null, e = 0; e < r.length; e++) if (r[e].getTime ? n = r[e].x.getTime() : n = r[e].x, "number" !== typeof r[e].y) {
                        ...
                        (r[e].indexLabel || t.indexLabel || r[e].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: r[e],
                            dataSeries: t,
                            point: {x: d + (D - d) / 2, y: 0 <= r[e].y ? k : m},
                            direction: 0 > r[e].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: d, y1: Math.min(k, m), x2: D, y2: Math.max(k, m)},
                            color: h
                        })
                    }
                }
        ...
        v.prototype.renderPie = function (a) {
            function f() {
                if (m &&
                    ...
                    for (var a = 0, c = 0, b = 0, f = 0, h = 0; h < n.length; h++) {
                        ...
                        var p = l[h], k = {percent: null, total: null}, y = null, k = x.getPercentAndTotal(m, g);
            ...
            function b(a) {
                ...
                for (c = 0; c < n.length; c++) {
                    ...
                    if (f > b) {
                        var h = 0.07 * C * Math.cos(l[c].midAngle), g = 0.07 * C * Math.sin(l[c].midAngle), e = !1;
                        if (n[c].exploded) {
                            if (1E-9 <
            ...
            function c(a, c) {
                var b = 0, b = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2,
            ...
            var x = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var m = this.data[a.dataSeriesIndexes[0]], n = m.dataPoints, p = 10, q = this.plotArea,
                    l = m.dataPointEOs, y = 2, r, s = 1.3, u = 20 / 180 * Math.PI, v = 6,
                ...
                if (0 !== A) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration :
                        ...
                        for (var b = l[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
                            var f = 0 === c ? l[c].startAngle : h, h = f + (l[c].endAngle - l[c].startAngle), g = !1;
                            h > b && (h = b, g = !0);
        ...
        v.prototype.renderFunnel = function (a) {
                ...
                if (u && B) {
                    ...
                    for (var G = 0, A = B.length - 1; G < B.length || 0 <= A; G++, A--) {
                        ...
                        if (u.indexLabelFormatter || b.indexLabelFormatter) v = {
                            chart: w.options, dataSeries: u, dataPoint: b, total: r.total,
                            percent: r.percent
                        };
            ...
            function r(a, b, c) {
                ...
                var k = {
                    startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, f) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                var J = A.x1 + D, V = A.x2 - D, N = A.y1 + z, L = A.y2 - z, W = a.targetCanvasCtx ||
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== B.length) {
                    ...
                    var D =
                        J + a / 2, Y = J, Z = J + a, S = u.reversed ? L : N, P = D - H / 2, ea = D + H / 2,
                        $ = u.reversed ? N + da : L - da, ya = u.reversed ? N : L;
                    a = [];
                    var D = [], Q = [], I = [], U = N, ia, ha = ($ - S) / (P - Y), ka = -ha,
                    ...
                    if (-1 !== J) {
                        ...
                        return {
                            source: W, dest: this.plotArea.ctx, animationCallback: function (a, b) {
        ...
        v.prototype.replaceKeywordsWithValue =
            function (a, f, b, c, h) {
                ...
                if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type || "funnel" === b.type || "pyramid" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                    var e = "#percent", d = "#total", k = this.getPercentAndTotal(b, f),
                        d = isNaN(k.total) ? d : k.total, e = isNaN(k.percent) ? e : k.percent;
                    do {
                        k = "";
                        if (b.percentFormatString) k = b.percentFormatString; else {
                            var k = "#,##0.", m = Math.max(Math.ceil(Math.log(1 / Math.abs(e)) / Math.LN10), 2);
        ...
        J.prototype.setLayout = function () {
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                    ...
                    var v = p.dataPoints[s], q = v.legendMarkerType ? v.legendMarkerType :
                        ...
                        l = this.chart.replaceKeywordsWithValue(l, v, p, s), q = {
                            markerType: q,
                            markerColor: y,
                            text: l,
                            textBlock: null,
            ...
            this.bounds = {x1: h, y1: c, x2: h + this.width, y2: c + this.height}
        };
        J.prototype.render = function () {
            var a = this.bounds.x1, f = this.bounds.y1, b = this.markerMargin, c = this.maxWidth, h = this.maxHeight,
                g = this.markerSize, e = this.rows;
            ...
            for (var d = 0, k = 0; k < e.length; k++) {
                for (var m = e[k], n = 0, p = 0; p < m.items.length; p++) {
                    var q = m.items[p], l = q.textBlock.x + a + (0 === p ? 0.2 * g : this.horizontalSpacing), t = f + d,
                        x = l;
                    ...
                    if ("error" === q.chartType) {
                        ...
                        var s = l - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                            u = t + 0.15 * this.lineHeight, v = 0.7 * this.lineHeight, w = v + 0.02 * this.lineHeight;
                        this.ctx.moveTo(s, u);
        ...
        D.prototype.getDataPointAtX = function (a, f) {
            ...
            var b = {dataPoint: null, distance: Infinity, index: NaN}, c = null, h = 0, g = 0, e = 1, d = Infinity,
                k = 0, m = 0, n = 0;
            ...
            for (; ;) {
                ...
                if (0 <= g && g < this.dataPoints.length) {
                    var c = this.dataPoints[g], p = this.axisX.logarithmic ? c.x > a ? c.x / a : a / c.x :
                        Math.abs(c.x - a);
        ...
        D.prototype.getDataPointAtXY = function (a, f, b) {
            ...
            b = b || !1;
            var c = [], h = 0, g = 0, e = 1, d = !1, k = Infinity, m = 0, n = 0, p = 0;
            ...
            for (; ;) {
                g = 0 < e ? p + h : p - h;
                if (0 <= g && g < this.dataPoints.length) {
                    var q = this.chart._eventManager.objectMap[this.dataPointIds[g]], l = this.dataPoints[g], t = null;
                    if (q) {
                        switch (this.type) {
                            case "column":
                            case "stackedColumn":
                            ...
                            case "splineArea":
                            case "scatter":
                                var x = qa("markerSize", l, this) || 4, r = b ? 20 : x,
                                    t = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - f, 2));
                                t <= r && c.push({dataPoint: l, dataPointIndex: g, dataSeries: this, distance: t});
                                q = Math.abs(q.x1 - a);
                                q <= k ? k = q : 0 < e ? m++ : n++;
                                t <= x / 2 && (d = !0);
                                break;
        ...
        A.prototype.createLabels = function () {
            var a, f, b = 0, c = 0, h, g = 0, d = 0, c = 0, c = this.interval, k = 0, t, m = 0.6 * this.chart.height, n;
            a = !1;
            ...
            for (b = 0; b < this.stripLines.length; b++) {
                ...
                a = new ma(this.ctx, {
                    ...
                    text: g.labelFormatter ?
                        g.labelFormatter({chart: this.chart, axis: this, stripLine: g}) : g.label,
                    textAlign: this.labelTextAlign,
        ...
        A.prototype.createLabelsAndCalculateWidth = function () {
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index) for (f =
                    ...
                    var c = this._labels[f].textBlock, h = c.measureText(), g = 0,
        ...
        A.setLayout = function (a, f, b, c, h, g) {
            var d, k, t, m, n = a[0] ? a[0].chart : f[0].chart, p = n.isNavigator ? 0 : 10, q = n._axes;
            ...
            if ("normal" === h) {
                ...
                r;) {
                    var H = 0, W = 0, S = 0, T = 0, Y = h = 0, P = 0, Z = 0, U = 0, X = 0, Q = 0, $ = 0;
                    ...
                    if (f && 0 < f.length) for (l = 0; l < f.length; l++) f[l].lineCoordinates.x1 = Math.round(g.x1 + Q + P), f[l].lineCoordinates.x2 =
                        ...
                        x1: d, y1: k + (X +
                            Y - w[l] - W), x2: t, y2: m, width: t - d, height: m - k
                    }, W += w[l] + f[l].margin;
                ...
                for (N = []; 4 > r;) {
                    ...
                    if (a && 0 < a.length) for (l = 0; l < a.length; l++) {
                        ...
                        a[l].lineCoordinates = {x1: t - L, y1: k, x2: t - L, y2: m, height: Math.abs(m - k)};
                        ...
                        a[l].bounds = {
                            x1: t - (F[l] +
                                L), y1: k, x2: t, y2: m, width: t - d, height: m - k
                        };
                    ...
                    if (f && 0 < f.length) for (l = 0; l < f.length; l++) {
                        ...
                        f[l].lineCoordinates = {x1: t + R, y1: k, x2: t + R, y2: m, height: Math.abs(m - k)};
        ...
        A.prototype.renderInterlacedColors =
            function () {
                var a = this.chart.plotArea.ctx, f, b, c = this.chart.plotArea, h = 0;
                f = !0;
        ...
        A.prototype.renderAxisLine = function () {
            var a = this.chart.ctx, f = s ? this.chart._preRenderCtx : a,
                ...
                c = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), h, d;
            f.save();
            if ("bottom" === this._position || "top" === this._position) {
        ...
        A.prototype.convertPixelToValue = function (a) {
            ...
            var f = 0, b = 0, c, f = !0, h = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
        ...
        A.prototype.calculateValueToPixelConversionParameters =
            function (a) {
                ...
                var f = {pixelPerUnit: null, minimum: null, reference: null}, b = this.lineCoordinates.width,
                    ...
                    b = "bottom" === this._position || "top" === this._position ? b : c, c = Math.abs(this.range);
        ...
        U.prototype.render = function (a, d, b) {
            ...
            var m = null === this.opacity ? 1 : this.opacity,
                p = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit *
                    this.thickness), q = this.chart.overlaidCanvasCtx, l = q.globalAlpha;
            q.globalAlpha = m;
            q.beginPath();
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type) {
                            ...
                            chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b ?
                                b : w.dataPoint.y
                        ...
                        if (D) {
                            ...
                            chart: this.chart,
                            axis: this.parent.options, crosshair: this.options, value: b ? b : w.dataPoint.x
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[v].type || "rangeArea" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type || "rangeSplineArea" === this.parent.dataSeries[v].type || "candlestick" === this.parent.dataSeries[v].type || "ohlc" === this.parent.dataSeries[v].type || "boxAndWhisker" === this.parent.dataSeries[v].type) {
                        ...
                        m.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options, crosshair: this.options, value: b ? b : w.dataPoint.y
                        }) : e(this.options.label) ? $(b ? b : w.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = z
        ...
        oa.prototype.highlightObjects = function (a) {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                if ((h = this.chart._eventManager.objectMap[h.dataSeries.dataPointIds[h.index]]) && h.objectType && "dataPoint" === h.objectType) {
                    var c = this.chart.data[h.dataSeriesIndex], g = c.dataPoints[h.dataPointIndex],
                        k = h.dataPointIndex;
        ...
        ia.prototype.mouseEventHandler = function (a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c]) if (c = this.objectMap[c], "dataPoint" === c.objectType) {
                    var h = this.chart.data[c.dataSeriesIndex], g = h.dataPoints[c.dataPointIndex],
                        e = c.dataPointIndex;
                    c.eventParameter = {
                        x: b.x, y: b.y, dataPoint: g,
                        dataSeries: h.options, dataPointIndex: e, dataSeriesIndex: h.index, chart: this.chart
                    };
                    c.eventContext = {
                        context: g,
                        userContext: g,
        ...
        ia.prototype.fireEvent = function (a, d, b) {
            if (a && d) {
                var c = a.eventParameter, h = a.eventContext, g = a.eventContext.userContext;
    ...
    Z = Ra.StockChart = function () {
        function k(d) {
            ...
            pa(e, {position: "absolute", textAlign: "left", cursor: "auto", webkitTapHighlightColor: "transparent"});
            return e
        }
        ...
        F.prototype.render = function (d) {
            ...
            if (this.options.charts) {
                ...
                var r = this.layoutManager.getFreeSpace(), a = r.height, r = r.height, f = this.options.charts.length;
                ...
                for (d = 0; d < f.length; d++) {
                    ...
                    this.layoutManager.registerSpace("top", {width: r.width, height: x[d]})
                }
                c = null;
        ...
        F.prototype.exportChart = function (d) {
            ...
            var e = d.format ? d.format : "png", k = d.fileName ? d.fileName : this.exportFileName,
            ...
            for (var f = [], b = 0; b < this.charts.length; b++) {
                ...
                f.push({canvas: c.overlaidCanvas, position: {x: c.container.offsetLeft, y: c.container.offsetTop}})
            }
            ...
            }), f.push({canvas: b.chart.overlaidCanvas, position: {x: b.panel.offsetLeft, y: b.panel.offsetTop}}));
        ...
        F.prototype.print =
            function () {
                var d = this.exportChart({toDataURL: !0}), e = document.createElement("iframe");
                ...
                var k = this, r = e.contentWindow || e.contentDocument.document || e.contentDocument;
                r.document.open();
        ...
        F.prototype._touchEventHandler = function (d) {
            if (d.changedTouches) {
                ...
                if (!(x && 1 < x.length)) {
                    ...
                    a.time = new Date;
                    try {
                        var b = a.y - this._lastTouchData.y, f = a.time - this._lastTouchData.time;
        ...
        D.prototype.mouseEventHandler = function (d) {
            if ("mousemove" === d.type || "click" === d.type) {
                ...
                if ((r = this.stockChart.getObjectAtXY(k.x, k.y, !1)) && "undefined" !== typeof this.objectMap[r]) if (r = this.objectMap[r], "rangeButton" === r.objectType) {
                    ...
                    x: k.x, y: k.y, inputField: a, inputFieldIndex: r.inputFieldIndex,
                    stockChart: this.stockChart
                }, r.eventContext = {
                    context: this.stockChart.rangeSelector,
                    userContext: a,
        ...
        D.prototype.fireEvent = function (d, e, k) {
            if (d && e) {
                var r = d.eventParameter, a = d.eventContext, f = d.eventContext.userContext;
        ...
        A.prototype._initialize = function () {
            ...
            if (this.enabled) {
                ...
                var t = this.stockChart.layoutManager.getFreeSpace(), s = t.x1, r = t.y1;
                ...
                this.bounds = {x1: s, y1: r, x2: s + this.width, y2: r + this.height}
        ...
        M.prototype._attachEvents = function () {
            ...
            z(this.navigator.panel, "mousedown", function (k) {
                if (k.target !== d.navigator.slider.panel && k.target !== d.leftHandle && k.target !== d.rightHandle) {
                    ...
                    a = s.x - (k + r) / 2;
                    if (s.x < k || s.x > r) {
                        var s = Math.max(0, k + a), b = Math.min(r + a, d.navigator.width);
            ...
            T && (this.eventsAttached || (this._attachEvents(), this.eventsAttached = !0), this.handleWidth = this.options.handleWidth ? this.handleWidth : 8, this.handleHeight = this.options.handleHeight ? Math.min(this.navigator.height, this.options.handleHeight) : 0.25 * this.navigator.height, this.leftHandle || (this.leftHandle = v("button", "canvasjs-slider-handle", "button"), this.leftHandle.innerHTML = "||", this.leftHandle.style.cssText =
                ...
                if (d.stockChart.navigatorClicked) {
                    ...
                    e(d.stockChart._rangeEventParameter) && (d.stockChart._rangeEventParameter =
                        {stockChart: d.stockChart, source: "navigator", index: null, minimum: s, maximum: r});
                    d.navigator.dynamicUpdate || (d.stockChart._rangeEventParameter.type = "rangeChanging", d.stockChart.dispatchEvent("rangeChanging", d.stockChart._rangeEventParameter, d.stockChart));
                    for (var a = 0; a < d.stockChart.charts.length; a++) {
                        k = d.stockChart.charts[a];
                        k.toolTip && k.toolTip.enabled && k.toolTip.hide();
        ...
        L.prototype._initialize = function () {
            ...
            if (T && this.enabled) {
                ...
                var s = this.stockChart.layoutManager.getFreeSpace(), r = s.x1, k = s.y1;
                ...
                for (k = 0; k < this.buttons.length; k++) {
                    ...
                    f.textBlock = a;
                    f.bounds = {x1: null, x2: null, y1: null, y2: null, width: null, height: null};
                    a.measureText();
        ...
        N.prototype._initialize = function (d) {
            this._updateOptions();
            var k = "1m 3m 6m YTD 1y All".split(" "), s = [1, 3, 6, null, 1, null],
