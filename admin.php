...
<div id="topmenu" style="height:30px;">
    ...
    <div style="width:100%;heigth:30px;">
        ...
        <div style="padding:8px;width:50%;float:right;"><a href="" onClick="logout();" id="ad" onMouseOver="admover();"
                                                           onMouseOut="admout();"><span
                        style="color:white;font-size:24px;">Dương Ngọc Bảo</span></a></div>
    </div>
